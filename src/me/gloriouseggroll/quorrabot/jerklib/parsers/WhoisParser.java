...
public class WhoisParser implements CommandParser
{
    ...
    public IRCEvent createEvent(IRCEvent event)
    {
        switch (event.numeric())
        {
            ...
            {
                // "<nick> :{[@|+]<channel><space>}"
                // :kubrick.freenode.net 319 scripy mohadib :@#me.gloriouseggroll.quorrabot.jerklib
                // kubrick.freenode.net 319 scripy mohadib :@#me.gloriouseggroll.quorrabot.jerklib ##swing
                if (we != null)
                {
