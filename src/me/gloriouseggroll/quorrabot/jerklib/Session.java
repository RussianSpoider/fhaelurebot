 ...
 */
package me.gloriouseggroll.quorrabot.jerklib;

import java.util.*;
import java.util.concurrent.ConcurrentLinkedQueue;
import me.gloriouseggroll.quorrabot.Quorrabot;
import me.gloriouseggroll.quorrabot.jerklib.ModeAdjustment.Action;
import me.gloriouseggroll.quorrabot.jerklib.events.ConnectionLostEvent;
...
import me.gloriouseggroll.quorrabot.jerklib.parsers.InternalEventParser;
import me.gloriouseggroll.quorrabot.jerklib.tasks.Task;

/**
 * Session contains methods to manage an IRC connection. Like
 * {@link me.gloriouseggroll.quorrabot.jerklib.Session#changeNick(String)} , {@link me.gloriouseggroll.quorrabot.jerklib.Session#setRejoinOnKick(boolean)} , {@link me.gloriouseggroll.quorrabot.jerklib.Session#getUserModes()}
 * etc.
 * <p/>
 ...
 * with
 * {@link me.gloriouseggroll.quorrabot.jerklib.Session#setInternalEventHandler(me.gloriouseggroll.quorrabot.jerklib.listeners.IRCEventListener)}
 * and
 * {@link me.gloriouseggroll.quorrabot.jerklib.Session#setInternalParser(me.gloriouseggroll.quorrabot.jerklib.parsers.InternalEventParser)}.
 * <p/>
 ...
 * @see ConnectionManager#requestConnection(String, int,
 * me.gloriouseggroll.quorrabot.jerklib.Profile)
 */
public class Session extends RequestGenerator
{
    ...
    class MessageTask extends TimerTask
    {
        ...
        public void run()
        {
            ...
            if (now - lastMessage >= Quorrabot.instance().getMessageInterval())
            {
     ...
     * @see me.gloriouseggroll.quorrabot.jerklib.parsers.InternalEventParser
     * @see me.gloriouseggroll.quorrabot.jerklib.parsers.DefaultInternalEventParser
     * @see me.gloriouseggroll.quorrabot.jerklib.parsers.CommandParser
     */
     ...
     *
     * @param handler
     * @see me.gloriouseggroll.quorrabot.jerklib.listeners.IRCEventListener
     ...
     * @param channel
     * @param msg
     * @see me.gloriouseggroll.quorrabot.jerklib.Channel#say(String)
     */
    public void sayChannel(Channel channel, String msg)
    {
        ...
        } else
        {
            if (msg.startsWith("/w "))
            {
                ...
                me.gloriouseggroll.quorrabot.Quorrabot.tgcSession.sayRaw(msg);
                return;
            }
    ...
    /*
     * (non-Javadoc) @see
     * me.gloriouseggroll.quorrabot.jerklib.RequestGenerator#changeNick(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc) @see
     * me.gloriouseggroll.quorrabot.jerklib.RequestGenerator#setAway(java.lang.String)
     */
    @Override
     ...
     * @see me.gloriouseggroll.quorrabot.jerklib.Session#getRequestedConnection()
     ...
     *
     * @param task
     * @see me.gloriouseggroll.quorrabot.jerklib.tasks.Task
     ...
     *
     * @return channels
     * @see me.gloriouseggroll.quorrabot.jerklib.Channel
     */
     ...
     * @see me.gloriouseggroll.quorrabot.jerklib.Session.State
     */
    State getState()
    {
