...
$.lang.data["net.phantombot.chatmoderator.autoban-usage"] = "Usage: !autoban [add / remove / get]";
$.lang.data["net.phantombot.chatmoderator.autoban-add-usage"] = "Usage: !autoban add (message)";
$.lang.data["net.phantombot.chatmoderator.autoban-add-success"] = "Phrase added to the auto-ban list.";
$.lang.data["net.phantombot.chatmoderator.autoban-remove-usage"] = "Usage: !autoban remove (id)";
$.lang.data["net.phantombot.chatmoderator.autoban-remove-success"] = "Phrase removed from the auto-ban list.";
$.lang.data["net.phantombot.chatmoderator.error"] = "That phrase does not exist.";
$.lang.data["net.phantombot.chatmoderator.autoban-get-usage"] = "Usage: !autoban get (id) - id's go from 1 to $1";
$.lang.data["net.phantombot.chatmoderator.autoban-get"] = "Phrase #$1 -> \"$2\"";
$.lang.data["net.phantombot.chatmoderator.autopurge-usage"] = "Usage: !autopurge [add / remove / get]";
$.lang.data["net.phantombot.chatmoderator.autopurge-add-usage"] = "Usage: !autopurge add (message)";
$.lang.data["net.phantombot.chatmoderator.autopurge-add-success"] = "Phrase added to the auto-purge list.";
$.lang.data["net.phantombot.chatmoderator.autopurge-remove-usage"] = "Usage: !autopurge remove (id)";
$.lang.data["net.phantombot.chatmoderator.autopurge-remove-success"] = "Phrase removed from the auto-purge list.";
$.lang.data["net.phantombot.chatmoderator.error"] = "That phrase does not exist.";
$.lang.data["net.phantombot.chatmoderator.autopurge-get-usage"] = "Usage: !autopurge get (id) - id's go from 1 to $1";
$.lang.data["net.phantombot.chatmoderator.autopurge-get"] = "Phrase #$1 -> \"$2\"";
$.lang.data["net.phantombot.chatmoderator.whitelist-usage"] = "Usage: !whitelist [add / remove / get]";
$.lang.data["net.phantombot.chatmoderator.whitelist-add-usage"] = "Usage: !whitelist add (message)";
$.lang.data["net.phantombot.chatmoderator.whitelist-add-success"] = "URL added to the whitelist.";
$.lang.data["net.phantombot.chatmoderator.whitelist-remove-usage"] = "Usage: !whitelist remove (id)";
$.lang.data["net.phantombot.chatmoderator.whitelist-remove-success"] = "URL removed from the whitelist.";
$.lang.data["net.phantombot.chatmoderator.error2"] = "That URL does not exist.";
$.lang.data["net.phantombot.chatmoderator.whitelist-get-usage"] = "Usage: !whitelist get (id) - id's go from 1 to $1";
$.lang.data["net.phantombot.chatmoderator.whitelist-get"] = "Whitelist #$1 -> \"$2\"";
